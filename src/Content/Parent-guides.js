           ...
           <div className="p-relative intro" style={{paddingTop: '80px'}}>
              ...
              <div className='container grid-xl'>
                <div className='text-center d-flex justify-content-center'>
                  ...
                  {/*ROW 2*/}
                  <Guides trans={true} color="dark" bg="bg-light" title="How to Access" titleColor="Canvas Parent" title2="Online" image={I1} link={HACPO}>
                    Learn how to access the online version of Canvas Parent to see more detail about your children's progress.
                  </Guides>
                  {/*ROW 3*/}                  
                  <Guides trans={true} color="light" bg="bg-white" title="How to Access the" titleColor="Horizon Parent Portal" title2="in Canvas Parent The App" image={I2} link={HAHPP}>
                  ...
                  {/*ROW 6*/}                  
                  <Guides trans={true} color="footer" bg="bg-light" title="How To" titleColor="Change Notification Settings" title2="in Canvas Parent The App" image={I5} link={HCNS}>
