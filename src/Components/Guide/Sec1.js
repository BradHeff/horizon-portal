  ...
  return (
        <Sections trans={true} color="light">
                    <div className='column col-md-12 col-6'>
                        <h1 data-aos="slide-right" data-aos-delay="200">Creating <span>Canvas</span> <br/>Account</h1>
                    ...
                    <div className='column col-md-12 col-4'>
                        <div className='img-border-invert border-image' data-aos="slide-left" data-aos-delay="200">
